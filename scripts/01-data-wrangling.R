...
# Dependent variable:
dep <- read.csv("data/raw/homicide-rates.csv", header = TRUE, skip = 1)
...
ind1 <- read.csv("data/raw/state-gdp-capita.csv", header = TRUE, skip = 1)
...
ind2 <- read.csv("data/raw/state-gdp-growth-percentage.csv", header = TRUE, skip = 1)
...
ind3 <- read.csv("data/raw/gini.csv", header = TRUE, skip = 1)
...
ind4 <- read.csv("data/raw/population-projection.csv",
                 header = TRUE,
                 skip   = 1)
...
ind5 <- read.csv("data/raw/population-extreme-poverty.csv", header = TRUE, skip = 1)
...
ind6 <- read.csv("data/raw/years-schooling.csv", header = TRUE, skip = 1)
